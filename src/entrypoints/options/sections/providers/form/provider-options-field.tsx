        ...
        label={(
          <div className="flex items-center justify-between w-full">
            <div className="flex items-center gap-1.5">
              <span>{i18n.t("options.providers.form.providerOptions")}</span>
              <HelpTooltip>{i18n.t("options.providers.form.providerOptionsHint")}</HelpTooltip>
            </div>
            <a
            ...
            >
              {i18n.t("options.providers.form.providerOptionsDocsLink")}
            </a>
          </div>
        )}
      />
