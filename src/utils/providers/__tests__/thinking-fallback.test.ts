...
function providerFor(provider: "openai-compatible" | "deepseek", providerOptions: Record<string, unknown>) {
  return { id: "p", name: "P", enabled: true, provider, apiKey: "key", model: "any-model", providerOptions } as unknown as APIProviderConfig
}
